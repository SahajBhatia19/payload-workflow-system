...
export interface User {
  ...
  name?: string | null;
  /**
   * Role determines workflow step assignments
   */
  role: 'admin' | 'reviewer' | 'manager' | 'user';
  updatedAt: string;
  createdAt: string;
  email: string;
...
export interface Blog {
  ...
  /**
   * Assign a workflow to this blog post
   */
  workflow?: (string | null) | Workflow;
  /**
   * Current step index in the assigned workflow
   */
...
export interface Workflow {
  ...
  /**
   * Define the ordered steps of this workflow
   */
  steps: {
    stepName: string;
    /**
     ...
     */
    assignedRole?: ('admin' | 'reviewer' | 'manager' | 'user') | null;
    /**
     * Optionally assign a specific user to this step
     */
...
export interface Contract {
  ...
  /**
   * Assign a workflow to this contract
   */
  workflow?: (string | null) | Workflow;
  /**
   * Current step index in the assigned workflow
...
export interface WorkflowLog {
  ...
  /**
   * The ID of the document this log entry belongs to
   */
  documentId: string;
  /**
   * The collection slug of the document
   */
  collection: string;
  /**
   * The step order index when this action was taken
   */
  stepId: number;
  user?: (string | null) | User;
  action: 'approved' | 'rejected' | 'commented' | 'skipped' | 'started';
  /**
   * Optional comment provided during the action
   */
  comment?: string | null;
  timestamp: string;
  updatedAt: string;
